...
const About = () => {
  ...
  return (
    <section id="about" className="min-h-screen py-20 bg-gradient-to-b from-neutral-900 via-gray-900 to-neutral-900 text-gray-300">
      {/* Outer wrapper – padding + centering */}

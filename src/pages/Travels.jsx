  ...
  const travels = [
    {
      ...
      description: 'Exploring the breathtaking landscapes of the Himalayas and discovering the beauty of high-altitude trekking.'
    },
    {
      icon: '🏖️',
      title: 'Coastal Journeys',
      description: 'Wandering along pristine beaches and experiencing the diverse cultures of coastal communities around the world.'
    },
    {
      icon: '🏛️',
      title: 'Cultural Explorations',
      description: 'Immersing in ancient civilizations and learning about the rich history and traditions of different cultures.'
    }
  ];

  return (
    <section id="travels" className="min-h-screen py-20 bg-gradient-to-br from-gray-200 to-gray-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
          {travels.map((travel, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-2">{travel.title}</h3>
